...
> **项目重构说明**: 原项目中的自动滚动功能已拆分为独立插件，位于 `autoScroll/` 文件夹中。当前项目专注于各个网站的特殊功能增强。
...
- 对话增强功能 (`chatgpt_enhancer.js`):
  - 提供 ChatGPT 对话页面的增强功能和优化体验。

## 独立插件

### Auto Scroll (自动滚动)

原项目中的自动滚动功能已拆分为独立插件，位于 `autoScroll/` 文件夹中。该插件提供：
